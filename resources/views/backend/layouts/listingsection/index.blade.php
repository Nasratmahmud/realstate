...
@section('content')
    ...
    <div class="page-header">
        <div>
            <h1 class="page-title">Listing Section</h1>
        </div>
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="card-description">Setup your work section, please <code>provide your valid
                                                data</code>.</p>
                                        <div class="mt-4">
                                            <form class="forms-sample" method="POST" action="{{ route('listing.update') }}"
