                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="card-description">Setup your property, please <code>provide your valid
                                                data</code>.</p>
                                        <div class="mt-4">
                                            <form class="forms-sample" method="POST" action="{{ route('aboutwork.update') }}"
                                                ...
                                                <div class="col mb-3">
                                                    <label>Description:</label>
                                                        <textarea name="description" id="summernote" class="form-control summer-note form-control-md border-left-0
                                                        @error('description') is-invalid @enderror">{{ old('description', $cms->description) }}</textarea>
                                                        @error('description')
                                                            <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong>
                                                            </span>
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="file" id="image" class="form-control form-control-md border-left-0 dropify" name="image"  data-default-file="{{ url('uploads/backend/'.$cms->image_url) }}">
                                                    @error('image')
